...
<head>
  ...
  <link rel="stylesheet" href="{!! asset('css/styles-panel.css') !!}">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
      <a class="nav-link collapsed" href="3" data-toggle="collapse" data-target="#collapseUtilities"
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ route('nota') }}">
                <i class="fas fa-sticky-note"></i>
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li>
              <p class="red">fecha de hoy: {{$date}}</p>
            </li>
  ...
  <script type="text/javascript" src="{!! asset('js/Chart.min.js') !!}" async></script>
